...
class NowPlayingMotionSpecTest {
    ...
    fun landscapeDelaysKeepRowsStaggeredAndHeaderLastOnExit() {
        ...
        assertEquals(NowPlayingMotionSpec.EnterStepDelayMs * 2, NowPlayingMotionSpec.enterDelayMs(phoneLayout, NowPlayingMotionSlot.SPECTRUM))
        ...
        assertEquals(NowPlayingMotionSpec.ExitStepDelayMs, NowPlayingMotionSpec.exitDelayMs(phoneLayout, NowPlayingMotionSlot.SPECTRUM))
        ...
        assertEquals(NowPlayingMotionSpec.EnterStepDelayMs, NowPlayingMotionSpec.enterDelayMs(splitLayout, NowPlayingMotionSlot.QUEUE))
        ...
        assertEquals(NowPlayingMotionSpec.EnterStepDelayMs * 2, NowPlayingMotionSpec.enterDelayMs(splitLayout, NowPlayingMotionSlot.SPECTRUM))
        ...
        assertEquals(NowPlayingMotionSpec.ExitStepDelayMs, NowPlayingMotionSpec.exitDelayMs(splitLayout, NowPlayingMotionSlot.SPECTRUM))
        ...
        assertEquals(NowPlayingMotionSpec.ExitStepDelayMs * 2, NowPlayingMotionSpec.exitDelayMs(splitLayout, NowPlayingMotionSlot.QUEUE))
